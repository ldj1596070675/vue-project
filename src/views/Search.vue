  ...
  computed: {
    ...
    searchDatalist () {
      return this.cinemaList.filter(item => item.name.includes(this.mytext) ||
            ...
            item.address.toUpperCase().includes(this.mytext.toUpperCase()) ||
            item.address.toLowerCase().includes(this.mytext.toLowerCase())
      )
    }
  },
  mounted () {
