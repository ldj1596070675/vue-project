<template>
    <div class="center">
        <div class="center-view">
            <div class="avatar">
                <img class="avator-icon" :src="logList.icon" />
                <div class="nick-name">{{logList.nickname}}</div>
            </div>
            ...
            <div class="margin-set">
                ...
                <span class="price-decimal"><i :style="{fontSize: '11px',fontStyle: 'normal'}">￥</i>0</span>
                <img class="arrow" src="data:image/png;base64," />
            </div>
            <div class="margin-set">
